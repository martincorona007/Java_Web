                ...
                <div class="">
                    <form method="POST" action="restaurantController" name="frmAddProduct">
                        <div class="form-group row">
                            <label for="example-date-input" class="col-2 col-form-label">First Name</label>
                            <div class="col-3">
                               <input class="form-control" type="text" name="f_name"value="<c:out value="${reservatt.f_name}" />" /> <br />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-date-input" class="col-2 col-form-label">Last Name</label>
                            <div class="col-3">
                              <input class="form-control" type="text" name="l_name"value="<c:out value="${reservatt.l_name}" />" /> <br /> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-date-input" class="col-2 col-form-label">Cell Phone</label>
                            <div class="col-3">
