...
<html>
    ...
    <body>
        <form method="POST" action="EcomerceController" name="frmAddProduct">
            ID : <input type="text" readonly="readonly" name="proId" value="<c:out value="${products.ID_p}" />" /> <br /> 
            Name : <input type="text" name="name"value="<c:out value="${products.name}" />" /> <br /> 
            Characteristics : <input type="text" name="charact"value="<c:out value="${products.charact}" />" /> <br /> 
